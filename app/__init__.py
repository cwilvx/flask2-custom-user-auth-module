...
api.add_resource(auth.views.GetCurrentUser, '/profile')
api.add_resource(auth.views.GetAllUsers, '/users')
api.add_resource(auth.views.GetUserById, '/users/<string:user_id>')
